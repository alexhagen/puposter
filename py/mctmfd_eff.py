...
m16_ratio_curve.plot_fit(linestyle='--', linecolor='#A7A9AC', addto=plot)
...
#                       place=(2.8, 3.0E-3))
plot.lines_on()
plot.ylabel(r'Rejection Ratio ($\eta_{Cf} : \eta_{DD}$) [ ]')
...
plot.markers_off()
plot.lines_on()
plot.lines['$r$'].set_linewidth(0.0)
plot.lines['$r$'].set_alpha(1.0)
plot.lines['$r$'].set_markersize(6)
